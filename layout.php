...
<body class="rs-smoother-yes">
    ...
    <!-- <div id="pre-load">
        <div id="loader" class="loader">
            <div class="loader-container has-theme-red">
                <div class="loader-icon"><img src="assets/images/logo/logo-icon.png" alt="Logo Icon"></div>
            </div>
        </div>
    </div> -->
    <!-- preloader end -->
            ...
            <div class="offcanvas-wrapper">
                <div class="offcanvas-content">
                    ...
                    <div class="offcanvas-about mb-30 d-none d-xl-block">
                        <p>
                            Empowering students through quality education, practical learning, and professional
                            training in healthcare, management, and degree programs.
                        </p>
                    </div>
                    <div class="offcanvas-gallery d-none d-xl-block">
                        <div class="offcanvas-gallery-thumb-wrapper">
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/images/courses/bba.jpg">
                                    <img src="assets/images/courses/bba.jpg" alt="image">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/images/courses/ecg-technician.jpg">
                                    <img src="assets/images/courses/ecg-technician.jpg" alt="image">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/images/courses/yoga.jpg">
                                    <img src="assets/images/courses/yoga.jpg" alt="image">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/images/courses/neuro-physiology.jpg">
                                    <img src="assets/images/courses/neuro-physiology.jpg" alt="image">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/images/courses/physiotherapy.jpg">
                                    <img src="assets/images/courses/physiotherapy.jpg" alt="image">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/images/courses/nursing-assistant.jpg">
                                    <img src="assets/images/courses/nursing-assistant.jpg" alt="image">
                                </a>
                            </div>
                        ...
                        <ul>
                            <li class="d-flex gap-15">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="https://maps.app.goo.gl/KTgYQphxzXGzSaF2A" target="_blank">B-1/99, Jail Rd,
                                        Block B, Harsh Vihar, Mandoli, Delhi, 110093</a>
                                </div>
                            </li>
                            <li class="d-flex gap-15">
                                <div class="offcanvas-contact-icon">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="https://maps.app.goo.gl/pggPFWTojGnv4ZnS9" target="_blank"><strong>Head Office :</strong> D1, 762,
                                        Jail Rd, near Mandoli, Shukar Bazar, Block B, Harsh Vihar, Mandoli,
                                        Delhi, 110093</a>
                                </div>
                            </li>
                            <li class="d-flex gap-15">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="tel:+91 9217900261"> +91 9217900261 </a>,
                                    <a href="tel:+011-43597115"> +011-43597115 </a>
                                </div>
                            </li>
                            <li class="d-flex gap-15">
                                <div class="offcanvas-contact-icon">
                    ...
                    <div class="offcanvas-social has-theme-red">
                        ...
                        <ul>
                            <li><a href="https://www.facebook.com/profile.php?id=100091510414471" target="_blank"><i
                                        class="ri-facebook-fill"></i></a></li>
                            <li><a href="https://www.instagram.com/sri__lakshmi__lal__institute?igsh=MWZlbDhma3I3d3Bsdg=="
                                    target="_blank"><i class="ri-instagram-fill"></i></a></li>
                            <li><a href="https://youtube.com/@srilakshmilalinstitute?si=mNNp0Bvb0GvvuucP"
                                    target="_blank"><i class="ri-youtube-fill"></i></a></li>
                            <li><a href="https://x.com/Sri_Lakshmi_Lal" target="_blank"><i
                                        class="ri-twitter-x-fill"></i></a></li>
                            <!-- <li><a href="#" target="_blank"><i class="ri-linkedin-box-fill"></i></a></li> -->
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="floating-buttons">
        ...
        <a href="tel:+919217900261" class="float-btn call-btn">
            <i class="bi bi-telephone-fill"></i>
        </a>

        <a href="https://wa.me/+919217900261" target="_blank" class="float-btn whatsapp-btn">
    ...
    <!-- back to top -->
    <div id="backtotop-wrap" class="rs-backtotop has-theme-red">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            document.querySelectorAll(".read-more-text").forEach(function (item) {
        ...
        `;
                ...
                const shortSpan = item.querySelector(".short-text");
                const fullSpan = item.querySelector(".full-text");
