...
<footer class="rs-footer-area rs-footer-one">
    <div class="rs-footer-shape">
        <img src="assets/images/shape/arrow-shape.webp" alt="image">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                    ...
                    <div class="rs-footer-left">
                        <div class="rs-footer-widget footer-1-col-1">
                            <div class="rs-footer-widget-logo">
                                <a href="/"><img src="assets/images/logo/logo.png" alt="logo" class="logo"></a>
                                <p class="mt-4 me-md-5 m-0">Sri Lakshmi Lal Institute of Paramedical Sciences &
                                    Management is committed to providing quality education, practical training, and
                                    career-focused programs that empower students to achieve academic excellence and
                        ...
                        <div class="rs-footer-widget-wrapper">
                            <div class="rs-footer-widget footer-1-col-3">
                                ...
                                <div class="rs-footer-widget-link has-theme-red">
                                    <ul>
                                        ...
                                        <li><a href="admissions.php">Admission Now</a></li>
                                        <li><a href="gallery.php">Institute Gallery</a></li>
                                        <li><a href="blog.php">Blog</a></li>
                                        <li><a href="contact-us.php">Contact us</a></li>
                                        <li><a href="all-cources.php">All Courses</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="rs-footer-widget footer-1-col-2">
                                <h5 class="rs-footer-widget-title">Our Courses</h5>
                                <div class="rs-footer-widget-link has-theme-red">
                                    <ul>
                                        <li><a href="cmlt-course.php">Medical Lab Technology</a></li>
                                        ...
                                        <li><a href="mba-course.php">MBA Course</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="rs-footer-widget footer-1-col-4">
                                ...
                                <div class="rs-footer-widget-content">
                                    <div class="rs-footer-widget-contact-info mt-0 d-block">
                                        <div class="rs-footer-content-item">
                                            <span>Phone:</span>
                                            <a href="tel:+919217900261">+91 9217900261</a>
                                            <a href="tel:+0113597115">+011-43597115</a>
                                        </div>
                                    </div>
                                    <div class="rs-footer-widget-contact-info mt-0">
                                        <div class="rs-footer-content-item">
                                            <span>Email:</span>
                                    ...
                                    <div class="rs-footer-widget-contact-info mt-0">
                                        <div class="rs-footer-content-item">
                                            <span>Address:</span>
                                            <a href="https://maps.app.goo.gl/AY8q78bjCh1YoQba9" target="_blank">B-1/99,
                                                Jail Road, Harsh Vihar, Delhi-110093</a>
                                        </div>
                                    </div>
                                    <div class="rs-footer-widget-social">
                                        <span class="rs-footer-social-title">Social Link:</span>
                                        <div
                                            class="rs-footer-social theme-social has-radius-none has-medium has-theme-red">
                                            <a href="https://www.facebook.com/profile.php?id=100091510414471" target="_blank"><svg width="14" height="22" viewBox="0 0 14 22" fill="none"
                                            ...
                                            <a href="https://www.instagram.com/sri__lakshmi__lal__institute?igsh=MWZlbDhma3I3d3Bsdg==" target="_blank"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <a href="https://youtube.com/@srilakshmilalinstitute?si=mNNp0Bvb0GvvuucP" target="_blank">
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        d="M23.5 6.2C23.2 5.1 22.4 4.3 21.3 4C19.5 3.5 12 3.5 12 3.5C12 3.5 4.5 3.5 2.7 4C1.6 4.3 0.8 5.1 0.5 6.2C0 8 0 12 0 12C0 12 0 16 0.5 17.8C0.8 18.9 1.6 19.7 2.7 20C4.5 20.5 12 20.5 12 20.5C12 20.5 19.5 20.5 21.3 20C22.4 19.7 23.2 18.9 23.5 17.8C24 16 24 12 24 12C24 12 24 8 23.5 6.2ZM9.5 15.5V8.5L15.8 12L9.5 15.5Z"
                                                        fill="#003a65" />
                                                </svg>
                                            </a>
            ...
            <div class="rs-footer-copyright-area rs-copyright-one">
                <div class="rs-footer-copyright-wrapper justify-content-center">
                    <div class="rs-footer-copyright-right justify-content-center">
                        <div class="rs-footer-copyright-item ">
                            <div class="rs-footer-copyright has-theme-red">
                                <p class="underline">
                                    ...
                                    <a target="_blank" href="https://hoverbusinessservices.com">
