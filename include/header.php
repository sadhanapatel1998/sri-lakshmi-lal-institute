...
<div class="mobile-announcement">
    <div class="announcement-track">
        ...
        <div class="announcement-content">
            <span class="badge-item">🎓 Admissions Open 2026-27</span>
            <span class="badge-item">🏥 35+ Professional Courses</span>
            <span class="badge-item">💼 100% Practical Training</span>
            <span class="badge-item">👨‍🏫 Expert Faculty</span>
            <span class="badge-item">📚 Degree • Diploma • Certificate</span>
            <span class="badge-item">🎯 Career Oriented Education</span>
            <span class="badge-item">📞 Enquiry Open Now</span>
        </div>
...
<section class="header-section">
    <header class="header-one">
        <div class="rs-header-area rs-header-three has-theme-red">
            <div class="container-fluid g-0">
                <div class="d-md-block d-none">
                    <div class="rs-header-top rs-header-top-one has-theme-red">
                        <div class="header-top-left">
                            <div class="header-top-content">

                                <span class="header-top-title">
                                    <a href="tel:+919217900261"> <i class="bi bi-telephone-fill"></i>
                                        +91 9217900261</a>,
                                    <a href="tel:+01143597115">
                                        +011-43597115</a>
                                </span>

                                <span class="header-top-title">
                                    <a href="mailto:laxmilalinstitue@gmail.com">
                                ...
                                <span class="header-top-title">
                                    ...
                                    B-1/99, Jail Road, Harsh Vihar, Delhi-110093
                                </span>
                ...
                <div id="rs-sticky-header" class="header-wrapper rs-sticky-header has-space">
                                ...
                                <li class="menu-item-has-children rs-mega-menu">
                                    ...
                                    <!-- <ul class="mega-menu mega-grid">
                                        ...
                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Paramedical Courses</a>
                                            <ul>
                                                <li><a href="ot-technician.php">O.T. Technician</a></li>
                                                <li><a href="lab-technician.php">Lab Technician</a></li>
                                                <li><a href="xray-technician.php">X-Ray Technician</a></li>
                                                <li><a href="ecg-technician.php">E.C.G. Technician</a></li>
                                                <li><a href="physiotherapy.php">Physiotherapy</a></li>
                                                <li><a href="neuro-physiology.php">Neuro Physiology</a></li>
                                                <li><a href="yoga-science.php">Yoga Science</a></li>
                                                <li><a href="acupuncture.php">Acupuncture</a></li>
                                            </ul>
                                        </li>

                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Nursing Courses</a>
                                            <ul>
                                                <li><a href="nursing-assistant.php">Nursing Assistant</a></li>
                                                <li><a href="dhsi.php">D.H.S.I.</a></li>
                                            </ul>
                                        </li>

                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Degree Courses</a>
                                            <ul>
                                                <li><a href="ba-course.php">B.A.</a></li>
                                                <li><a href="bsc-course.php">B.Sc.</a></li>
                                                <li><a href="bcom-course.php">B.Com.</a></li>
                                                <li><a href="ma-course.php">M.A.</a></li>
                                                <li><a href="msc-course.php">M.Sc.</a></li>
                                                <li><a href="mcom-course.php">M.Com.</a></li>
                                                <li><a href="bed-special.php">B.Ed Special</a></li>
                                            </ul>
                                        </li>

                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Management Courses</a>
                                            <ul>
                                                <li><a href="bba-course.php">BBA</a></li>
                                                <li><a href="mba-course.php">MBA</a></li>
                                                <li><a href="bsw-course.php">BSW</a></li>
                                                <li><a href="msw-course.php">MSW</a></li>
                                    ...
                                    <ul class="mega-menu mega-grid">
                                        ...
                                        <!-- Certificate Courses -->
                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Certificate Courses</a>
                                            <ul>
                                                <li><a href="cmlt-course.php">C.M.L.T. – Medical Lab Technology</a></li>
                                                <li><a href="crit-course.php">C.R.I.T. – Radio Imaging Technology</a>
                                                </li>
                                                <li><a href="cet-course.php">C.E.T. – ECG Technology</a></li>
                                                <li><a href="cnp-course.php">C.N.P. – Neurophysiology</a></li>
                                                <li><a href="cy-course.php">C.Y. – Yoga</a></li>
                                            </ul>
                                        </li>

                                        <!-- Diploma Courses -->
                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Diploma Courses</a>
                                            <ul>
                                                <li><a href="dmlt-course.php">D.M.L.T. – Medical Lab Technology</a></li>
                                                <li><a href="drit-course.php">D.R.I.T. – Radio Imaging Technology</a>
                                                </li>
                                                <li><a href="dnp-course.php">D.N.P. – Neurophysiology</a></li>
                                                <li><a href="dpt-course.php">D.P.T. – Physiotherapy</a></li>
                                                <li><a href="dap-course.php">D.A.P. – Ayurvedic Pharmacy</a></li>
                                                <li><a href="dott-course.php">D.O.T.T. – Operation Theater
                                                        Technology</a></li>
                                        ...
                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Degree Courses</a>
                                            <ul>
                                                <li><a href="bmlt-course.php">B.M.L.T.</a></li>
                                                <li><a href="brit-course.php">B.R.I.T.</a></li>
                                        ...
                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Post Graduate Courses</a>
                                            <ul>
                                                <li><a href="pg-diploma-naturopathy.php">PG Diploma in Naturopathy &
                                                        Yoga Science</a></li>
                                                <li><a href="pg-diploma-acupuncture.php">PG Diploma in Acupuncture</a>
                                                </li>
                                                <li><a href="pg-diploma-yoga.php">PG Diploma in Yoga</a></li>
                                            </ul>
                                        </li>

                                        <!-- Specialized Health Courses -->
                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Specialized Health Courses</a>
                                            <ul>
                                                <li><a href="dhsi-course.php">D.H.S.I.</a></li>
                                                <li><a href="gda-course.php">G.D.A.</a></li>
                                            </ul>
                                        </li>

                                        <!-- Academic Courses -->
                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Academic Courses</a>
                                            <ul>
                                                <li><a href="ba-course.php">B.A.</a></li>
                                                <li><a href="bcom-course.php">B.Com.</a></li>
                                                <li><a href="bsc-course.php">B.Sc.</a></li>
                                        ...
                                        <li class="rs-menu-item">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="mba-course.php">MBA</a></li>
                                                <li><a href="event-management.php">Event Management</a></li>
                                                <li><a href="pgdbm-course.php">PGDBM</a></li>
                                            </ul>
                                        </li>

                                        <!-- Social Work Courses -->
                                        <li class="rs-menu-item">
                                            <a href="javascript:void(0);" class="title">Social Work Courses</a>
                                            <ul>
                                                <li><a href="bsw-course.php">BSW</a></li>
                                                <li><a href="msw-course.php">MSW</a></li>
                                            </ul>
                    ...
                    <div class="header-right">
                        ...
                        <div class="header-btn">
                            <a class="rs-btn has-icon has-black hover-red radius-15" href="contact-us.php">
    ...
    <header class="header-two">
        <div class="rs-header-area rs-header-three has-theme-red">
            <div class="container-fluid g-0">
                <div class="header-wrapper has-space">
                    <div class="header-left">
                        <div class="header-logo">
                            <a href="/"><img src="assets/images/logo/logo.png" alt="logo"></a>
                        </div>
