            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-xl-7">
                    <div class="error-wrapper text-center">
                        <h1 class="section-title white-text mt-25 mb-20"> 404 !</h1>

                        <h3 class="mb-20"> Your Journey Doesn't End Here </h3>

                        <p> The page may have been moved, renamed, or is temporarily unavailable. Return to the homepage
                            to explore our courses, admissions, and career-focused programs. </p>
